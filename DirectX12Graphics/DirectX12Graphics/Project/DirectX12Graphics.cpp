// DirectX12Graphics.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
#include "framework.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_DIRECTX12GRAPHICS, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_DIRECTX12GRAPHICS));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    RECT rc{ 0, 0, DEFAULT_WINCX, DEFAULT_WINCY };
